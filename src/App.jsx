...
import {
  buildDrawingSnapshot,
  clamp,
  createCharacteristic,
  cropCanvasArea,
  fieldLabel,
  formatBytes,
  getDefaultBalloonPosition,
  getNormalizedPoint,
...
import {
  buildAutoBalloonCandidates,
  getEmbeddedAutoBalloonCandidates,
  getOcrAutoBalloonCandidates,
  renumberAutoBalloonCandidates,
} from "./lib/autoBalloon.js";
import Field from "./components/Field.jsx";
import ToolButton from "./components/ToolButton.jsx";
import ResizeHandle from "./components/ResizeHandle.jsx";
import { AutoBalloonPreview, LeaderLayer, TextLayer } from "./components/CanvasOverlay.jsx";
import AutoBalloonReview from "./components/AutoBalloonReview.jsx";
import BalloonEditor from "./components/BalloonEditor.jsx";
import CharacteristicTable from "./components/CharacteristicTable.jsx";
import MeasurementWorkspace from "./components/MeasurementWorkspace.jsx";
          ...
          <section ref={drawingPanelRef} className="drawing-panel">
            <div className="panel-toolbar">
              <div className="tool-group">
                ...
                <ToolButton active={mode === "balloon"} title="Add balloon (B)" onClick={() => switchMode("balloon")} icon={<Circle size={17} />} />
                <ToolButton active={mode === "autoBalloon"} title="Review balloon candidates (A)" onClick={() => switchMode("autoBalloon")} icon={<ScanSearch size={17} />} />
                <ToolButton active={mode === "text"} title="Text select (T)" onClick={() => switchMode("text")} icon={<TextSelect size={17} />} />
