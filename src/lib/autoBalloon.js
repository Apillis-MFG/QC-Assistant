...
export function getAutoBalloonLabel(value) {
...
export function isLikelyPageNoise(candidate, pageCount) {
...
export function dedupeAutoBalloonCandidates(candidates) {
  const accepted = [];
...
export function positionAutoBalloonCandidates(candidates, selectionRect, startNo, pageAspectRatio) {
...
export function getNearestAutoBalloonEdge(candidate, rect, pageAspectRatio) {
...
export function spreadAutoBalloonEdgePositions(group, rect, edge) {
...
export function getAutoBalloonPosition({ candidate, selectionRect, edge, axisPosition }) {
...
export function compareAutoBalloonClockwise(a, b) {
